...
Execute task 33 for the sos-app specification.

## Task Description
Implement OAuth 2.0 Google authentication strategy

## Code Reuse
**Leverage existing code**: passport-google-oauth20 npm package

## Requirements Reference
**Requirements**: 1.0.1 (social authentication)
...
Execute with @spec-task-executor agent the following task: "Implement OAuth 2.0 Google authentication strategy"

```
Use the @spec-task-executor agent to implement task 33: "Implement OAuth 2.0 Google authentication strategy" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Implement OAuth 2.0 Google authentication strategy
- Leverage: passport-google-oauth20 npm package
- Requirements: 1.0.1 (social authentication)

## Instructions
- Implement ONLY task 33: "Implement OAuth 2.0 Google authentication strategy"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 33 --mode complete
```
