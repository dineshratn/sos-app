...
Execute task 156 for the sos-app specification.

## Task Description
Implement rate limiting middleware

## Code Reuse
**Leverage existing code**: express-rate-limit npm package

## Requirements Reference
**Requirements**: Security NFR - Rate Limiting
...
Execute with @spec-task-executor agent the following task: "Implement rate limiting middleware"

```
Use the @spec-task-executor agent to implement task 156: "Implement rate limiting middleware" for the sos-app specification and include all the below context.
...
- Leverage: express-rate-limit npm package
- Requirements: Security NFR - Rate Limiting

## Instructions
- Implement ONLY task 156: "Implement rate limiting middleware"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 156 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 156 --mode complete
```
