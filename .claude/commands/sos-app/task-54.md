...
Execute task 54 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Write unit tests for User Service"

```
Use the @spec-task-executor agent to implement task 54: "Write unit tests for User Service" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 54: "Write unit tests for User Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 54 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 54 --mode complete
```
