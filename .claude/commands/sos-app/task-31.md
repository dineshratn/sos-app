...
Execute task 31 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create token refresh endpoint"

```
Use the @spec-task-executor agent to implement task 31: "Create token refresh endpoint" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 31: "Create token refresh endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 31 --mode complete
```
