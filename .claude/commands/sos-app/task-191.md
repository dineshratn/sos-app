...
Execute task 191 for the sos-app specification.

## Task Description
Implement WebSocket connection for location updates

## Code Reuse
**Leverage existing code**: socket.io-client npm package

## Requirements Reference
**Requirements**: 3.0.1, 3.0.2
...
Execute with @spec-task-executor agent the following task: "Implement WebSocket connection for location updates"

```
Use the @spec-task-executor agent to implement task 191: "Implement WebSocket connection for location updates" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 191
- Description: Implement WebSocket connection for location updates
- Leverage: socket.io-client npm package
- Requirements: 3.0.1, 3.0.2

## Instructions
- Implement ONLY task 191: "Implement WebSocket connection for location updates"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 191 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 191 --mode complete
```
