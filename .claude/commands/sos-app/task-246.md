...
Execute task 246 for the sos-app specification.

## Task Description
Create medical profile screen
...
Execute with @spec-task-executor agent the following task: "Create medical profile screen"

```
Use the @spec-task-executor agent to implement task 246: "Create medical profile screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 246
- Description: Create medical profile screen
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 246: "Create medical profile screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 246 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 246 --mode complete
```
