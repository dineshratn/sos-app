...
Execute task 11 for the sos-app specification.

## Task Description
Create PostgreSQL StatefulSet for Kubernetes
...
Execute with @spec-task-executor agent the following task: "Create PostgreSQL StatefulSet for Kubernetes"

```
Use the @spec-task-executor agent to implement task 11: "Create PostgreSQL StatefulSet for Kubernetes" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Create PostgreSQL StatefulSet for Kubernetes
- Requirements: Reliability NFR - Availability

## Instructions
- Implement ONLY task 11: "Create PostgreSQL StatefulSet for Kubernetes"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 11 --mode complete
```
