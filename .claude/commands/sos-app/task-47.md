...
Execute task 47 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create UPDATE user profile endpoint"

```
Use the @spec-task-executor agent to implement task 47: "Create UPDATE user profile endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 47
- Description: Create UPDATE user profile endpoint
- Requirements: 1.0.5

## Instructions
- Implement ONLY task 47: "Create UPDATE user profile endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 47 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 47 --mode complete
```
