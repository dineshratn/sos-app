...
Execute task 132 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement media upload endpoint"

```
Use the @spec-task-executor agent to implement task 132: "Implement media upload endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 132
- Description: Implement media upload endpoint
- Requirements: 8.0.3

## Instructions
- Implement ONLY task 132: "Implement media upload endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 132 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 132 --mode complete
```
