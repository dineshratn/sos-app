...
Execute task 213 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create SOS button component"

```
Use the @spec-task-executor agent to implement task 213: "Create SOS button component" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 213
- Description: Create SOS button component
- Requirements: 2.0.1

## Instructions
- Implement ONLY task 213: "Create SOS button component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 213 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 213 --mode complete
```
