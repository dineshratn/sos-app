...
Execute task 236 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create registration flow screens"

```
Use the @spec-task-executor agent to implement task 236: "Create registration flow screens" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 236
- Description: Create registration flow screens
- Requirements: 1.0.1, 1.0.2

## Instructions
- Implement ONLY task 236: "Create registration flow screens"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 236 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 236 --mode complete
```
