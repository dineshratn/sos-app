...
Execute task 243 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement WebSocket manager with OkHttp"

```
Use the @spec-task-executor agent to implement task 243: "Implement WebSocket manager with OkHttp" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 243
- Description: Implement WebSocket manager with OkHttp
- Requirements: 3.0, 8.0

## Instructions
- Implement ONLY task 243: "Implement WebSocket manager with OkHttp"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 243 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 243 --mode complete
```
