...
Execute task 160 for the sos-app specification.

## Task Description
Create route proxies for Emergency Service
...
Execute with @spec-task-executor agent the following task: "Create route proxies for Emergency Service"

```
Use the @spec-task-executor agent to implement task 160: "Create route proxies for Emergency Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 160
- Description: Create route proxies for Emergency Service
- Requirements: 2.0

## Instructions
- Implement ONLY task 160: "Create route proxies for Emergency Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 160 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 160 --mode complete
```
