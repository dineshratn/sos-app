...
Execute task 223 for the sos-app specification.

## Task Description
Create emergency history list view
...
Execute with @spec-task-executor agent the following task: "Create emergency history list view"

```
Use the @spec-task-executor agent to implement task 223: "Create emergency history list view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 223
- Description: Create emergency history list view
- Requirements: 9.0.2

## Instructions
- Implement ONLY task 223: "Create emergency history list view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 223 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 223 --mode complete
```
