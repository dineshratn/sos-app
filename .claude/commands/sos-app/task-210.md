...
Execute task 210 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create login view"

```
Use the @spec-task-executor agent to implement task 210: "Create login view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 210
- Description: Create login view
- Requirements: 1.0.3, 1.0.6

## Instructions
- Implement ONLY task 210: "Create login view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 210 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 210 --mode complete
```
