...
Execute task 133 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement voice-to-text integration"

```
Use the @spec-task-executor agent to implement task 133: "Implement voice-to-text integration" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 133
- Description: Implement voice-to-text integration
- Requirements: 8.0.2

## Instructions
- Implement ONLY task 133: "Implement voice-to-text integration"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 133 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 133 --mode complete
```
