...
Execute task 192 for the sos-app specification.

## Task Description
Create emergency contacts management page

## Requirements Reference
**Requirements**: 4.0.1, 4.0.5
...
Execute with @spec-task-executor agent the following task: "Create emergency contacts management page"

```
Use the @spec-task-executor agent to implement task 192: "Create emergency contacts management page" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 192
- Description: Create emergency contacts management page
- Requirements: 4.0.1, 4.0.5

## Instructions
- Implement ONLY task 192: "Create emergency contacts management page"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 192 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 192 --mode complete
```
