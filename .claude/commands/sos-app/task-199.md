...
Execute task 199 for the sos-app specification.

## Task Description
Create emergency chat interface

## Requirements Reference
**Requirements**: 8.0.1, 8.0.5
...
Execute with @spec-task-executor agent the following task: "Create emergency chat interface"

```
Use the @spec-task-executor agent to implement task 199: "Create emergency chat interface" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 199
- Description: Create emergency chat interface
- Requirements: 8.0.1, 8.0.5

## Instructions
- Implement ONLY task 199: "Create emergency chat interface"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 199 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 199 --mode complete
```
