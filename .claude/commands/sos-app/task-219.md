...
Execute task 219 for the sos-app specification.

## Task Description
Create emergency contacts list view
...
Execute with @spec-task-executor agent the following task: "Create emergency contacts list view"

```
Use the @spec-task-executor agent to implement task 219: "Create emergency contacts list view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 219
- Description: Create emergency contacts list view
- Requirements: 4.0.1

## Instructions
- Implement ONLY task 219: "Create emergency contacts list view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 219 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 219 --mode complete
```
