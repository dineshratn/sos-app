...
Execute task 198 for the sos-app specification.

## Task Description
Implement emergency report PDF export

## Code Reuse
**Leverage existing code**: jspdf npm package
...
Execute with @spec-task-executor agent the following task: "Implement emergency report PDF export"

```
Use the @spec-task-executor agent to implement task 198: "Implement emergency report PDF export" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 198
- Description: Implement emergency report PDF export
- Leverage: jspdf npm package
- Requirements: 9.0.3

## Instructions
- Implement ONLY task 198: "Implement emergency report PDF export"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 198 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 198 --mode complete
```
