...
Execute task 34 for the sos-app specification.

## Task Description
Implement OAuth 2.0 Apple authentication strategy

## Code Reuse
**Leverage existing code**: passport-apple npm package
...
Execute with @spec-task-executor agent the following task: "Implement OAuth 2.0 Apple authentication strategy"

```
Use the @spec-task-executor agent to implement task 34: "Implement OAuth 2.0 Apple authentication strategy" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Implement OAuth 2.0 Apple authentication strategy
- Leverage: passport-apple npm package
- Requirements: 1.0.1 (social authentication)

## Instructions
- Implement ONLY task 34: "Implement OAuth 2.0 Apple authentication strategy"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 34 --mode complete
```
