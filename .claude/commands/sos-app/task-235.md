...
Execute task 235 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create login screen"

```
Use the @spec-task-executor agent to implement task 235: "Create login screen" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 235: "Create login screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 235 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 235 --mode complete
```
