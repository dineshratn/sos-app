...
Execute task 200 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement WebSocket connection for chat"

```
Use the @spec-task-executor agent to implement task 200: "Implement WebSocket connection for chat" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 200
- Description: Implement WebSocket connection for chat
- Requirements: 8.0.1

## Instructions
- Implement ONLY task 200: "Implement WebSocket connection for chat"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 200 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 200 --mode complete
```
