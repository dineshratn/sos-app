...
Execute task 128 for the sos-app specification.

## Task Description
Implement send message handler

## Requirements Reference
**Requirements**: 8.0.1, 8.0.4
...
Execute with @spec-task-executor agent the following task: "Implement send message handler"

```
Use the @spec-task-executor agent to implement task 128: "Implement send message handler" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 128
- Description: Implement send message handler
- Requirements: 8.0.1, 8.0.4

## Instructions
- Implement ONLY task 128: "Implement send message handler"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 128 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 128 --mode complete
```
