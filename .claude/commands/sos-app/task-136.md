...
Execute task 136 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Write unit tests for Communication Service"

```
Use the @spec-task-executor agent to implement task 136: "Write unit tests for Communication Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 136
- Description: Write unit tests for Communication Service
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 136: "Write unit tests for Communication Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 136 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 136 --mode complete
```
