...
Execute task 155 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement JWT validation middleware"

```
Use the @spec-task-executor agent to implement task 155: "Implement JWT validation middleware" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 155: "Implement JWT validation middleware"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 155 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 155 --mode complete
```
