...
Execute task 30 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create login endpoint"

```
Use the @spec-task-executor agent to implement task 30: "Create login endpoint" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 30: "Create login endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 30 --mode complete
```
