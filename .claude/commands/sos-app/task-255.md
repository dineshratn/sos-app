...
Execute task 255 for the sos-app specification.

## Task Description
Write instrumented tests for Android app
...
Execute with @spec-task-executor agent the following task: "Write instrumented tests for Android app"

```
Use the @spec-task-executor agent to implement task 255: "Write instrumented tests for Android app" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 255
- Description: Write instrumented tests for Android app
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 255: "Write instrumented tests for Android app"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 255 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 255 --mode complete
```
