...
Execute task 250 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement FCM push notifications"

```
Use the @spec-task-executor agent to implement task 250: "Implement FCM push notifications" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 250
- Description: Implement FCM push notifications
- Requirements: 11.0.1

## Instructions
- Implement ONLY task 250: "Implement FCM push notifications"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 250 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 250 --mode complete
```
