...
Execute task 187 for the sos-app specification.

## Task Description
Create emergency button component

## Requirements Reference
**Requirements**: 2.0.1, 2.0.5
...
Execute with @spec-task-executor agent the following task: "Create emergency button component"

```
Use the @spec-task-executor agent to implement task 187: "Create emergency button component" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 187
- Description: Create emergency button component
- Requirements: 2.0.1, 2.0.5

## Instructions
- Implement ONLY task 187: "Create emergency button component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 187 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 187 --mode complete
```
