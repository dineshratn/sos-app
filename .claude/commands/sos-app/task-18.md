...
Execute task 18 for the sos-app specification.

## Task Description
Create Kafka topic configuration script

## Requirements Reference
**Requirements**: 2.0 (Emergency Alert), 3.0 (Location), 11.0 (Notifications)
...
Execute with @spec-task-executor agent the following task: "Create Kafka topic configuration script"

```
Use the @spec-task-executor agent to implement task 18: "Create Kafka topic configuration script" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 18
- Description: Create Kafka topic configuration script
- Requirements: 2.0 (Emergency Alert), 3.0 (Location), 11.0 (Notifications)

## Instructions
- Implement ONLY task 18: "Create Kafka topic configuration script"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 18 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 18 --mode complete
```
