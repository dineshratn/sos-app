...
Execute task 204 for the sos-app specification.

## Task Description
Create notification permission prompt

## Requirements Reference
**Requirements**: 6.0.6, 11.0
...
Execute with @spec-task-executor agent the following task: "Create notification permission prompt"

```
Use the @spec-task-executor agent to implement task 204: "Create notification permission prompt" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 204
- Description: Create notification permission prompt
- Requirements: 6.0.6, 11.0

## Instructions
- Implement ONLY task 204: "Create notification permission prompt"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 204 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 204 --mode complete
```
