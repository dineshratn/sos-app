...
Execute task 105 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Write unit tests for Location Service"

```
Use the @spec-task-executor agent to implement task 105: "Write unit tests for Location Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 105
- Description: Write unit tests for Location Service
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 105: "Write unit tests for Location Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 105 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 105 --mode complete
```
