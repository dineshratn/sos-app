...
Execute task 211 for the sos-app specification.

## Task Description
Create registration flow views
...
Execute with @spec-task-executor agent the following task: "Create registration flow views"

```
Use the @spec-task-executor agent to implement task 211: "Create registration flow views" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 211
- Description: Create registration flow views
- Requirements: 1.0.1, 1.0.2

## Instructions
- Implement ONLY task 211: "Create registration flow views"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 211 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 211 --mode complete
```
