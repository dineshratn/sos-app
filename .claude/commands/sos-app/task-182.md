...
Execute task 182 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Initialize Next.js project with TypeScript"

```
Use the @spec-task-executor agent to implement task 182: "Initialize Next.js project with TypeScript" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 182: "Initialize Next.js project with TypeScript"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 182 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 182 --mode complete
```
