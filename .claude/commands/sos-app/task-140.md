...
Execute task 140 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create device repository"

```
Use the @spec-task-executor agent to implement task 140: "Create device repository" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 140
- Description: Create device repository
- Requirements: 7.0

## Instructions
- Implement ONLY task 140: "Create device repository"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 140 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 140 --mode complete
```
