...
Execute task 125 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create MongoDB collection for messages"

```
Use the @spec-task-executor agent to implement task 125: "Create MongoDB collection for messages" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 125
- Description: Create MongoDB collection for messages
- Requirements: 8.0

## Instructions
- Implement ONLY task 125: "Create MongoDB collection for messages"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 125 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 125 --mode complete
```
