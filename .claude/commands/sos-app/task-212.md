...
Execute task 212 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create main dashboard view"

```
Use the @spec-task-executor agent to implement task 212: "Create main dashboard view" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 212: "Create main dashboard view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 212 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 212 --mode complete
```
