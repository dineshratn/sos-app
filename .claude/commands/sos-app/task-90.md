...
Execute task 90 for the sos-app specification.

## Task Description
Write unit tests for Emergency Service
...
Execute with @spec-task-executor agent the following task: "Write unit tests for Emergency Service"

```
Use the @spec-task-executor agent to implement task 90: "Write unit tests for Emergency Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 90
- Description: Write unit tests for Emergency Service
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 90: "Write unit tests for Emergency Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 90 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 90 --mode complete
```
