...
Execute task 233 for the sos-app specification.

## Task Description
Set up networking layer with Retrofit

## Code Reuse
**Leverage existing code**: Retrofit, OkHttp libraries
...
Execute with @spec-task-executor agent the following task: "Set up networking layer with Retrofit"

```
Use the @spec-task-executor agent to implement task 233: "Set up networking layer with Retrofit" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 233
- Description: Set up networking layer with Retrofit
- Leverage: Retrofit, OkHttp libraries
- Requirements: 6.0

## Instructions
- Implement ONLY task 233: "Set up networking layer with Retrofit"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 233 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 233 --mode complete
```
