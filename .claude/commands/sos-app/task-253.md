...
Execute task 253 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create device management screen"

```
Use the @spec-task-executor agent to implement task 253: "Create device management screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 253
- Description: Create device management screen
- Requirements: 7.0

## Instructions
- Implement ONLY task 253: "Create device management screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 253 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 253 --mode complete
```
