...
Execute task 71 for the sos-app specification.

## Task Description
Implement field-level encryption utility

## Requirements Reference
**Requirements**: Security NFR - Encryption (AES-256)
...
Execute with @spec-task-executor agent the following task: "Implement field-level encryption utility"

```
Use the @spec-task-executor agent to implement task 71: "Implement field-level encryption utility" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 71
- Description: Implement field-level encryption utility
- Requirements: Security NFR - Encryption (AES-256)

## Instructions
- Implement ONLY task 71: "Implement field-level encryption utility"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 71 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 71 --mode complete
```
