...
Execute task 214 for the sos-app specification.

## Task Description
Create countdown modal view
...
Execute with @spec-task-executor agent the following task: "Create countdown modal view"

```
Use the @spec-task-executor agent to implement task 214: "Create countdown modal view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 214
- Description: Create countdown modal view
- Requirements: 2.0.5

## Instructions
- Implement ONLY task 214: "Create countdown modal view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 214 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 214 --mode complete
```
