...
Execute task 102 for the sos-app specification.

## Task Description
Implement reverse geocoding service

## Requirements Reference
**Requirements**: 3.0 (for contact notifications)
...
Execute with @spec-task-executor agent the following task: "Implement reverse geocoding service"

```
Use the @spec-task-executor agent to implement task 102: "Implement reverse geocoding service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 102
- Description: Implement reverse geocoding service
- Requirements: 3.0 (for contact notifications)

## Instructions
- Implement ONLY task 102: "Implement reverse geocoding service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 102 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 102 --mode complete
```
