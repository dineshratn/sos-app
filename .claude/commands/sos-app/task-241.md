...
Execute task 241 for the sos-app specification.

## Task Description
Create active emergency screen

## Requirements Reference
**Requirements**: 2.0.7, 3.0, 4.0.4
...
Execute with @spec-task-executor agent the following task: "Create active emergency screen"

```
Use the @spec-task-executor agent to implement task 241: "Create active emergency screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 241
- Description: Create active emergency screen
- Requirements: 2.0.7, 3.0, 4.0.4

## Instructions
- Implement ONLY task 241: "Create active emergency screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 241 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 241 --mode complete
```
