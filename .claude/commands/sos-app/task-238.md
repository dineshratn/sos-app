...
Execute task 238 for the sos-app specification.

## Task Description
Create SOS button composable
...
Execute with @spec-task-executor agent the following task: "Create SOS button composable"

```
Use the @spec-task-executor agent to implement task 238: "Create SOS button composable" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 238
- Description: Create SOS button composable
- Requirements: 2.0.1

## Instructions
- Implement ONLY task 238: "Create SOS button composable"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 238 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 238 --mode complete
```
