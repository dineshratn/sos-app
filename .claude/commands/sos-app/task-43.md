...
Execute task 43 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create database migration for user_profiles table"

```
Use the @spec-task-executor agent to implement task 43: "Create database migration for user_profiles table" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 43
- Description: Create database migration for user_profiles table
- Requirements: 1.0.2

## Instructions
- Implement ONLY task 43: "Create database migration for user_profiles table"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 43 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 43 --mode complete
```
