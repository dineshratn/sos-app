...
Execute task 183 for the sos-app specification.

## Task Description
Create authentication context and hooks

## Code Reuse
**Leverage existing code**: @sos-app/api-client

## Requirements Reference
**Requirements**: 1.0.3, 1.0.5
...
Execute with @spec-task-executor agent the following task: "Create authentication context and hooks"

```
Use the @spec-task-executor agent to implement task 183: "Create authentication context and hooks" for the sos-app specification and include all the below context.
...
- Leverage: @sos-app/api-client
- Requirements: 1.0.3, 1.0.5

## Instructions
- Implement ONLY task 183: "Create authentication context and hooks"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 183 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 183 --mode complete
```
