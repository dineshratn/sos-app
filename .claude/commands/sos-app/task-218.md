...
Execute task 218 for the sos-app specification.

## Task Description
Implement WebSocket manager with Starscream

## Code Reuse
**Leverage existing code**: Starscream pod

## Requirements Reference
**Requirements**: 3.0, 8.0
...
Execute with @spec-task-executor agent the following task: "Implement WebSocket manager with Starscream"

```
Use the @spec-task-executor agent to implement task 218: "Implement WebSocket manager with Starscream" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 218
- Description: Implement WebSocket manager with Starscream
- Leverage: Starscream pod
- Requirements: 3.0, 8.0

## Instructions
- Implement ONLY task 218: "Implement WebSocket manager with Starscream"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 218 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 218 --mode complete
```
