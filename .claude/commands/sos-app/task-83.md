...
Execute task 83 for the sos-app specification.

## Task Description
Create cancel emergency endpoint
...
Execute with @spec-task-executor agent the following task: "Create cancel emergency endpoint"

```
Use the @spec-task-executor agent to implement task 83: "Create cancel emergency endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 83
- Description: Create cancel emergency endpoint
- Requirements: 2.0.5

## Instructions
- Implement ONLY task 83: "Create cancel emergency endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 83 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 83 --mode complete
```
