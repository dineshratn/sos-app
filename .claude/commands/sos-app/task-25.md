...
Execute task 25 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create database migration for sessions table"

```
Use the @spec-task-executor agent to implement task 25: "Create database migration for sessions table" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 25: "Create database migration for sessions table"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 25 --mode complete
```
