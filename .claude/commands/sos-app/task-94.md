...
Execute task 94 for the sos-app specification.

## Task Description
Create location repository with batch writes

## Code Reuse
**Leverage existing code**: pgx Go library
...
Execute with @spec-task-executor agent the following task: "Create location repository with batch writes"

```
Use the @spec-task-executor agent to implement task 94: "Create location repository with batch writes" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 94
- Description: Create location repository with batch writes
- Leverage: pgx Go library
- Requirements: 3.0.1, Performance NFR

## Instructions
- Implement ONLY task 94: "Create location repository with batch writes"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 94 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 94 --mode complete
```
