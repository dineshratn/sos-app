...
Execute task 195 for the sos-app specification.

## Task Description
Create medical profile form sections
...
Execute with @spec-task-executor agent the following task: "Create medical profile form sections"

```
Use the @spec-task-executor agent to implement task 195: "Create medical profile form sections" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 195
- Description: Create medical profile form sections
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 195: "Create medical profile form sections"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 195 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 195 --mode complete
```
