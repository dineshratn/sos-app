...
Execute task 222 for the sos-app specification.

## Task Description
Implement lock screen medical info widget
...
Execute with @spec-task-executor agent the following task: "Implement lock screen medical info widget"

```
Use the @spec-task-executor agent to implement task 222: "Implement lock screen medical info widget" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 222
- Description: Implement lock screen medical info widget
- Requirements: 5.0.3

## Instructions
- Implement ONLY task 222: "Implement lock screen medical info widget"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 222 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 222 --mode complete
```
