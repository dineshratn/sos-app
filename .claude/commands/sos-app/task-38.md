...
Execute task 38 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement MFA verification endpoint"

```
Use the @spec-task-executor agent to implement task 38: "Implement MFA verification endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Implement MFA verification endpoint
- Requirements: Security NFR - MFA

## Instructions
- Implement ONLY task 38: "Implement MFA verification endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 38 --mode complete
```
