...
Execute task 49 for the sos-app specification.

## Task Description
Create GET emergency contacts endpoint
...
Execute with @spec-task-executor agent the following task: "Create GET emergency contacts endpoint"

```
Use the @spec-task-executor agent to implement task 49: "Create GET emergency contacts endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 49
- Description: Create GET emergency contacts endpoint
- Requirements: 4.0.1

## Instructions
- Implement ONLY task 49: "Create GET emergency contacts endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 49 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 49 --mode complete
```
