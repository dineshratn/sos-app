...
Execute task 208 for the sos-app specification.

## Task Description
Set up networking layer with Alamofire

## Code Reuse
**Leverage existing code**: Alamofire pod
...
Execute with @spec-task-executor agent the following task: "Set up networking layer with Alamofire"

```
Use the @spec-task-executor agent to implement task 208: "Set up networking layer with Alamofire" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 208
- Description: Set up networking layer with Alamofire
- Leverage: Alamofire pod
- Requirements: 6.0

## Instructions
- Implement ONLY task 208: "Set up networking layer with Alamofire"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 208 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 208 --mode complete
```
