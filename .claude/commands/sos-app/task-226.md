...
Execute task 226 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement push notification handling"

```
Use the @spec-task-executor agent to implement task 226: "Implement push notification handling" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 226: "Implement push notification handling"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 226 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 226 --mode complete
```
