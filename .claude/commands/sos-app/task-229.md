...
Execute task 229 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create device management view"

```
Use the @spec-task-executor agent to implement task 229: "Create device management view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 229
- Description: Create device management view
- Requirements: 7.0

## Instructions
- Implement ONLY task 229: "Create device management view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 229 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 229 --mode complete
```
