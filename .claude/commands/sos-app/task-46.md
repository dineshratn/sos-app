...
Execute task 46 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create GET user profile endpoint"

```
Use the @spec-task-executor agent to implement task 46: "Create GET user profile endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 46
- Description: Create GET user profile endpoint
- Requirements: 1.0.5

## Instructions
- Implement ONLY task 46: "Create GET user profile endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 46 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 46 --mode complete
```
