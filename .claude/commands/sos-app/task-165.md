...
Execute task 165 for the sos-app specification.

## Task Description
Implement WebSocket proxy for Location Service
...
Execute with @spec-task-executor agent the following task: "Implement WebSocket proxy for Location Service"

```
Use the @spec-task-executor agent to implement task 165: "Implement WebSocket proxy for Location Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 165
- Description: Implement WebSocket proxy for Location Service
- Requirements: 3.0

## Instructions
- Implement ONLY task 165: "Implement WebSocket proxy for Location Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 165 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 165 --mode complete
```
