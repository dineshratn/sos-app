...
Execute task 32 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create logout endpoint"

```
Use the @spec-task-executor agent to implement task 32: "Create logout endpoint" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 32: "Create logout endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 32 --mode complete
```
