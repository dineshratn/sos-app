...
Execute task 97 for the sos-app specification.

## Task Description
Create GET current location endpoint
...
Execute with @spec-task-executor agent the following task: "Create GET current location endpoint"

```
Use the @spec-task-executor agent to implement task 97: "Create GET current location endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 97
- Description: Create GET current location endpoint
- Requirements: 3.0

## Instructions
- Implement ONLY task 97: "Create GET current location endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 97 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 97 --mode complete
```
