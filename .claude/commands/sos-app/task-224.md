...
Execute task 224 for the sos-app specification.

## Task Description
Create emergency detail view
...
Execute with @spec-task-executor agent the following task: "Create emergency detail view"

```
Use the @spec-task-executor agent to implement task 224: "Create emergency detail view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 224
- Description: Create emergency detail view
- Requirements: 9.0.3

## Instructions
- Implement ONLY task 224: "Create emergency detail view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 224 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 224 --mode complete
```
