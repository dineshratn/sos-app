...
Execute task 245 for the sos-app specification.

## Task Description
Create add/edit contact screen

## Requirements Reference
**Requirements**: 4.0.1, 4.0.6
...
Execute with @spec-task-executor agent the following task: "Create add/edit contact screen"

```
Use the @spec-task-executor agent to implement task 245: "Create add/edit contact screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 245
- Description: Create add/edit contact screen
- Requirements: 4.0.1, 4.0.6

## Instructions
- Implement ONLY task 245: "Create add/edit contact screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 245 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 245 --mode complete
```
