...
Execute task 202 for the sos-app specification.

## Task Description
Implement service worker for PWA support

## Code Reuse
**Leverage existing code**: workbox npm package

## Requirements Reference
**Requirements**: 12.0, 6.0.2
...
Execute with @spec-task-executor agent the following task: "Implement service worker for PWA support"

```
Use the @spec-task-executor agent to implement task 202: "Implement service worker for PWA support" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 202
- Description: Implement service worker for PWA support
- Leverage: workbox npm package
- Requirements: 12.0, 6.0.2

## Instructions
- Implement ONLY task 202: "Implement service worker for PWA support"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 202 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 202 --mode complete
```
