...
Execute task 28 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement JWT token validation middleware"

```
Use the @spec-task-executor agent to implement task 28: "Implement JWT token validation middleware" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 28: "Implement JWT token validation middleware"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 28 --mode complete
```
