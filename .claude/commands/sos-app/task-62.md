...
Execute task 62 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create MedicalCondition model"

```
Use the @spec-task-executor agent to implement task 62: "Create MedicalCondition model" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 62
- Description: Create MedicalCondition model
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 62: "Create MedicalCondition model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 62 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 62 --mode complete
```
