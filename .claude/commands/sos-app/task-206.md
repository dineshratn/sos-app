...
Execute task 206 for the sos-app specification.

## Task Description
Write E2E tests for web app

## Code Reuse
**Leverage existing code**: playwright npm package
...
Execute with @spec-task-executor agent the following task: "Write E2E tests for web app"

```
Use the @spec-task-executor agent to implement task 206: "Write E2E tests for web app" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 206
- Description: Write E2E tests for web app
- Leverage: playwright npm package
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 206: "Write E2E tests for web app"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 206 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 206 --mode complete
```
