...
Execute task 251 for the sos-app specification.

## Task Description
Implement foreground service for background location
...
Execute with @spec-task-executor agent the following task: "Implement foreground service for background location"

```
Use the @spec-task-executor agent to implement task 251: "Implement foreground service for background location" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 251
- Description: Implement foreground service for background location
- Requirements: 6.0.5

## Instructions
- Implement ONLY task 251: "Implement foreground service for background location"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 251 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 251 --mode complete
```
