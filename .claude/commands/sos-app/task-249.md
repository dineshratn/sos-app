...
Execute task 249 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create chat screen"

```
Use the @spec-task-executor agent to implement task 249: "Create chat screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 249
- Description: Create chat screen
- Requirements: 8.0.1, 8.0.5

## Instructions
- Implement ONLY task 249: "Create chat screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 249 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 249 --mode complete
```
