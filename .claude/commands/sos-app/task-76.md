...
Execute task 76 for the sos-app specification.

## Task Description
Create database repository for Emergency
...
Execute with @spec-task-executor agent the following task: "Create database repository for Emergency"

```
Use the @spec-task-executor agent to implement task 76: "Create database repository for Emergency" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 76
- Description: Create database repository for Emergency
- Leverage: pgx Go library
- Requirements: 2.0

## Instructions
- Implement ONLY task 76: "Create database repository for Emergency"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 76 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 76 --mode complete
```
