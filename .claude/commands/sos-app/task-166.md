...
Execute task 166 for the sos-app specification.

## Task Description
Implement WebSocket proxy for Communication Service
...
Execute with @spec-task-executor agent the following task: "Implement WebSocket proxy for Communication Service"

```
Use the @spec-task-executor agent to implement task 166: "Implement WebSocket proxy for Communication Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 166
- Description: Implement WebSocket proxy for Communication Service
- Requirements: 8.0

## Instructions
- Implement ONLY task 166: "Implement WebSocket proxy for Communication Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 166 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 166 --mode complete
```
