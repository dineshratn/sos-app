...
Execute task 75 for the sos-app specification.

## Task Description
Create database schema for emergencies table
...
Execute with @spec-task-executor agent the following task: "Create database schema for emergencies table"

```
Use the @spec-task-executor agent to implement task 75: "Create database schema for emergencies table" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 75
- Description: Create database schema for emergencies table
- Requirements: 2.0

## Instructions
- Implement ONLY task 75: "Create database schema for emergencies table"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 75 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 75 --mode complete
```
