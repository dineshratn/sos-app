...
Execute task 122 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Write unit tests for Notification Service"

```
Use the @spec-task-executor agent to implement task 122: "Write unit tests for Notification Service" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 122: "Write unit tests for Notification Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 122 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 122 --mode complete
```
