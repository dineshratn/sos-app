...
Execute task 88 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement escalation logic service"

```
Use the @spec-task-executor agent to implement task 88: "Implement escalation logic service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 88
- Description: Implement escalation logic service
- Requirements: 4.0.3

## Instructions
- Implement ONLY task 88: "Implement escalation logic service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 88 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 88 --mode complete
```
