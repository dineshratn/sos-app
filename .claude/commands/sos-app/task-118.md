...
Execute task 118 for the sos-app specification.

## Task Description
Implement escalation notification service

## Requirements Reference
**Requirements**: 4.0.3, 11.0.4
...
Execute with @spec-task-executor agent the following task: "Implement escalation notification service"

```
Use the @spec-task-executor agent to implement task 118: "Implement escalation notification service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 118
- Description: Implement escalation notification service
- Requirements: 4.0.3, 11.0.4

## Instructions
- Implement ONLY task 118: "Implement escalation notification service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 118 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 118 --mode complete
```
