...
Execute task 256 for the sos-app specification.

## Task Description
Create Terraform configuration for cloud resources

## Requirements Reference
**Requirements**: Reliability NFR - Availability
...
Execute with @spec-task-executor agent the following task: "Create Terraform configuration for cloud resources"

```
Use the @spec-task-executor agent to implement task 256: "Create Terraform configuration for cloud resources" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 256
- Description: Create Terraform configuration for cloud resources
- Requirements: Reliability NFR - Availability

## Instructions
- Implement ONLY task 256: "Create Terraform configuration for cloud resources"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 256 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 256 --mode complete
```
