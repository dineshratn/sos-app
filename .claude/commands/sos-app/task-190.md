...
Execute task 190 for the sos-app specification.

## Task Description
Integrate Google Maps for location display

## Code Reuse
**Leverage existing code**: @react-google-maps/api npm package

## Requirements Reference
**Requirements**: 3.0.2, 3.0.3
...
Execute with @spec-task-executor agent the following task: "Integrate Google Maps for location display"

```
Use the @spec-task-executor agent to implement task 190: "Integrate Google Maps for location display" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 190
- Description: Integrate Google Maps for location display
- Leverage: @react-google-maps/api npm package
- Requirements: 3.0.2, 3.0.3

## Instructions
- Implement ONLY task 190: "Integrate Google Maps for location display"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 190 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 190 --mode complete
```
