...
Execute task 175 for the sos-app specification.

## Task Description
Create first aid guidance prompt template
...
Execute with @spec-task-executor agent the following task: "Create first aid guidance prompt template"

```
Use the @spec-task-executor agent to implement task 175: "Create first aid guidance prompt template" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 175
- Description: Create first aid guidance prompt template
- Requirements: 10.0

## Instructions
- Implement ONLY task 175: "Create first aid guidance prompt template"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 175 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 175 --mode complete
```
