...
Execute task 123 for the sos-app specification.

## Task Description
Create Communication Service project structure

## Requirements Reference
**Requirements**: 8.0 (Communication During Emergencies)
...
Execute with @spec-task-executor agent the following task: "Create Communication Service project structure"

```
Use the @spec-task-executor agent to implement task 123: "Create Communication Service project structure" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 123
- Description: Create Communication Service project structure
- Requirements: 8.0 (Communication During Emergencies)

## Instructions
- Implement ONLY task 123: "Create Communication Service project structure"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 123 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 123 --mode complete
```
