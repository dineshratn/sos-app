...
Execute task 231 for the sos-app specification.

## Task Description
Write UI tests for iOS app
...
Execute with @spec-task-executor agent the following task: "Write UI tests for iOS app"

```
Use the @spec-task-executor agent to implement task 231: "Write UI tests for iOS app" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 231
- Description: Write UI tests for iOS app
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 231: "Write UI tests for iOS app"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 231 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 231 --mode complete
```
