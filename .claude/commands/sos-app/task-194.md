...
Execute task 194 for the sos-app specification.

## Task Description
Create medical profile page
...
Execute with @spec-task-executor agent the following task: "Create medical profile page"

```
Use the @spec-task-executor agent to implement task 194: "Create medical profile page" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 194
- Description: Create medical profile page
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 194: "Create medical profile page"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 194 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 194 --mode complete
```
