...
Execute task 237 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create main dashboard screen"

```
Use the @spec-task-executor agent to implement task 237: "Create main dashboard screen" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 237: "Create main dashboard screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 237 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 237 --mode complete
```
