...
Execute task 240 for the sos-app specification.
...
```
Use the @spec-task-executor agent to implement task 240: "Implement location manager service" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 240: "Implement location manager service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 240 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 240 --mode complete
```
