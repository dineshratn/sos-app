...
Execute task 163 for the sos-app specification.

## Task Description
Create route proxies for Device Service
...
Execute with @spec-task-executor agent the following task: "Create route proxies for Device Service"

```
Use the @spec-task-executor agent to implement task 163: "Create route proxies for Device Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 163
- Description: Create route proxies for Device Service
- Requirements: 7.0

## Instructions
- Implement ONLY task 163: "Create route proxies for Device Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 163 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 163 --mode complete
```
