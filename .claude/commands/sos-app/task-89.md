...
Execute task 89 for the sos-app specification.

## Task Description
Implement auto-trigger emergency endpoint (for IoT devices)
...
Execute with @spec-task-executor agent the following task: "Implement auto-trigger emergency endpoint (for IoT devices)"

```
Use the @spec-task-executor agent to implement task 89: "Implement auto-trigger emergency endpoint (for IoT devices)" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 89
- Description: Implement auto-trigger emergency endpoint (for IoT devices)
- Requirements: 7.0.2

## Instructions
- Implement ONLY task 89: "Implement auto-trigger emergency endpoint (for IoT devices)"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 89 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 89 --mode complete
```
