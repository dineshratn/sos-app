...
Execute task 44 for the sos-app specification.

## Task Description
Create EmergencyContact model

## Requirements Reference
**Requirements**: 4.0 (Emergency Contact Management)
...
Execute with @spec-task-executor agent the following task: "Create EmergencyContact model"

```
Use the @spec-task-executor agent to implement task 44: "Create EmergencyContact model" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 44
- Description: Create EmergencyContact model
- Requirements: 4.0 (Emergency Contact Management)

## Instructions
- Implement ONLY task 44: "Create EmergencyContact model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 44 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 44 --mode complete
```
