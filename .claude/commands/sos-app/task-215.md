...
Execute task 215 for the sos-app specification.

## Task Description
Implement location manager service

## Requirements Reference
**Requirements**: 2.0.2, 3.0.1, 6.0.5
...
Execute with @spec-task-executor agent the following task: "Implement location manager service"

```
Use the @spec-task-executor agent to implement task 215: "Implement location manager service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 215
- Description: Implement location manager service
- Requirements: 2.0.2, 3.0.1, 6.0.5

## Instructions
- Implement ONLY task 215: "Implement location manager service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 215 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 215 --mode complete
```
