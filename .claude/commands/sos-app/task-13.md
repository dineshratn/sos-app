...
Execute task 13 for the sos-app specification.

## Task Description
Create TimescaleDB StatefulSet for location data

## Requirements Reference
**Requirements**: 3.0 (Real-time Location Sharing)
...
Execute with @spec-task-executor agent the following task: "Create TimescaleDB StatefulSet for location data"

```
Use the @spec-task-executor agent to implement task 13: "Create TimescaleDB StatefulSet for location data" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: Create TimescaleDB StatefulSet for location data
- Requirements: 3.0 (Real-time Location Sharing)

## Instructions
- Implement ONLY task 13: "Create TimescaleDB StatefulSet for location data"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 13 --mode complete
```
