...
Execute task 36 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create password reset confirmation endpoint"

```
Use the @spec-task-executor agent to implement task 36: "Create password reset confirmation endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create password reset confirmation endpoint
- Requirements: 1.0.4

## Instructions
- Implement ONLY task 36: "Create password reset confirmation endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 36 --mode complete
```
