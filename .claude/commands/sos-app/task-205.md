...
Execute task 205 for the sos-app specification.

## Task Description
Implement geolocation permission handling

## Requirements Reference
**Requirements**: 2.0.8, 3.0
...
Execute with @spec-task-executor agent the following task: "Implement geolocation permission handling"

```
Use the @spec-task-executor agent to implement task 205: "Implement geolocation permission handling" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 205
- Description: Implement geolocation permission handling
- Requirements: 2.0.8, 3.0

## Instructions
- Implement ONLY task 205: "Implement geolocation permission handling"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 205 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 205 --mode complete
```
