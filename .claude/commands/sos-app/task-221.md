...
Execute task 221 for the sos-app specification.

## Task Description
Create medical profile view
...
Execute with @spec-task-executor agent the following task: "Create medical profile view"

```
Use the @spec-task-executor agent to implement task 221: "Create medical profile view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 221
- Description: Create medical profile view
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 221: "Create medical profile view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 221 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 221 --mode complete
```
