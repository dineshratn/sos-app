...
Execute task 260 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create Grafana dashboards"

```
Use the @spec-task-executor agent to implement task 260: "Create Grafana dashboards" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 260: "Create Grafana dashboards"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 260 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 260 --mode complete
```
