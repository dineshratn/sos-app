...
Execute task 248 for the sos-app specification.

## Task Description
Create emergency detail screen
...
Execute with @spec-task-executor agent the following task: "Create emergency detail screen"

```
Use the @spec-task-executor agent to implement task 248: "Create emergency detail screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 248
- Description: Create emergency detail screen
- Requirements: 9.0.3

## Instructions
- Implement ONLY task 248: "Create emergency detail screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 248 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 248 --mode complete
```
