...
Execute task 216 for the sos-app specification.

## Task Description
Create active emergency view
...
Execute with @spec-task-executor agent the following task: "Create active emergency view"

```
Use the @spec-task-executor agent to implement task 216: "Create active emergency view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 216
- Description: Create active emergency view
- Requirements: 2.0.7, 3.0, 4.0.4

## Instructions
- Implement ONLY task 216: "Create active emergency view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 216 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 216 --mode complete
```
