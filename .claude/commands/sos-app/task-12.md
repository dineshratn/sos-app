...
Execute task 12 for the sos-app specification.

## Task Description
Create PostgreSQL database initialization script

## Requirements Reference
**Requirements**: Security NFR - RBAC
...
Execute with @spec-task-executor agent the following task: "Create PostgreSQL database initialization script"

```
Use the @spec-task-executor agent to implement task 12: "Create PostgreSQL database initialization script" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Create PostgreSQL database initialization script
- Requirements: Security NFR - RBAC

## Instructions
- Implement ONLY task 12: "Create PostgreSQL database initialization script"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 12 --mode complete
```
