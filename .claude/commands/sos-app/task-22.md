...
Execute task 22 for the sos-app specification.

## Task Description
Create User model and database schema

## Code Reuse
**Leverage existing code**: sequelize or typeorm npm package

## Requirements Reference
**Requirements**: 1.0.1, 1.0.2
...
Execute with @spec-task-executor agent the following task: "Create User model and database schema"

```
Use the @spec-task-executor agent to implement task 22: "Create User model and database schema" for the sos-app specification and include all the below context.
...
- Leverage: sequelize or typeorm npm package
- Requirements: 1.0.1, 1.0.2

## Instructions
- Implement ONLY task 22: "Create User model and database schema"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 22 --mode complete
```
