...
Execute task 3 for the sos-app specification.

## Task Description
Create shared types library structure
...
Execute with @spec-task-executor agent the following task: "Create shared types library structure"

```
Use the @spec-task-executor agent to implement task 3: "Create shared types library structure" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 3
- Description: Create shared types library structure
- Requirements: All

## Instructions
- Implement ONLY task 3: "Create shared types library structure"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 3 --mode complete
```
