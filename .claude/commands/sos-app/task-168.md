...
Execute task 168 for the sos-app specification.

## Task Description
Create health check endpoint

## Requirements Reference
**Requirements**: Reliability NFR - Health Checks
...
Execute with @spec-task-executor agent the following task: "Create health check endpoint"

```
Use the @spec-task-executor agent to implement task 168: "Create health check endpoint" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 168: "Create health check endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 168 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 168 --mode complete
```
