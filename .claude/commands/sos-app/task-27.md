...
Execute task 27 for the sos-app specification.

## Task Description
Implement JWT token generation utility

## Code Reuse
**Leverage existing code**: jsonwebtoken npm package

## Requirements Reference
**Requirements**: 1.0.3, Security NFR
...
Execute with @spec-task-executor agent the following task: "Implement JWT token generation utility"

```
Use the @spec-task-executor agent to implement task 27: "Implement JWT token generation utility" for the sos-app specification and include all the below context.
...
- Leverage: jsonwebtoken npm package
- Requirements: 1.0.3, Security NFR

## Instructions
- Implement ONLY task 27: "Implement JWT token generation utility"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 27 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 27 --mode complete
```
