...
Execute task 60 for the sos-app specification.

## Task Description
Create MedicalMedication model
...
Execute with @spec-task-executor agent the following task: "Create MedicalMedication model"

```
Use the @spec-task-executor agent to implement task 60: "Create MedicalMedication model" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 60
- Description: Create MedicalMedication model
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 60: "Create MedicalMedication model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 60 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 60 --mode complete
```
