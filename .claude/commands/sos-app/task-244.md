...
Execute task 244 for the sos-app specification.

## Task Description
Create emergency contacts screen
...
Execute with @spec-task-executor agent the following task: "Create emergency contacts screen"

```
Use the @spec-task-executor agent to implement task 244: "Create emergency contacts screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 244
- Description: Create emergency contacts screen
- Requirements: 4.0.1

## Instructions
- Implement ONLY task 244: "Create emergency contacts screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 244 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 244 --mode complete
```
