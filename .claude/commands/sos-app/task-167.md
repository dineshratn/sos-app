...
Execute task 167 for the sos-app specification.

## Task Description
Implement circuit breaker for service calls

## Code Reuse
**Leverage existing code**: opossum npm package
...
Execute with @spec-task-executor agent the following task: "Implement circuit breaker for service calls"

```
Use the @spec-task-executor agent to implement task 167: "Implement circuit breaker for service calls" for the sos-app specification and include all the below context.
...
- Leverage: opossum npm package
- Requirements: Reliability NFR - Fault Tolerance

## Instructions
- Implement ONLY task 167: "Implement circuit breaker for service calls"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 167 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 167 --mode complete
```
