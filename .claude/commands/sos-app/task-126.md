...
Execute task 126 for the sos-app specification.

## Task Description
Set up Socket.IO server with Redis adapter

## Code Reuse
**Leverage existing code**: socket.io, socket.io-redis npm packages
...
Execute with @spec-task-executor agent the following task: "Set up Socket.IO server with Redis adapter"

```
Use the @spec-task-executor agent to implement task 126: "Set up Socket.IO server with Redis adapter" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 126
- Description: Set up Socket.IO server with Redis adapter
- Leverage: socket.io, socket.io-redis npm packages
- Requirements: 8.0.1

## Instructions
- Implement ONLY task 126: "Set up Socket.IO server with Redis adapter"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 126 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 126 --mode complete
```
