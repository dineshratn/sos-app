...
Execute task 58 for the sos-app specification.

## Task Description
Create MedicalAllergy model
...
Execute with @spec-task-executor agent the following task: "Create MedicalAllergy model"

```
Use the @spec-task-executor agent to implement task 58: "Create MedicalAllergy model" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 58
- Description: Create MedicalAllergy model
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 58: "Create MedicalAllergy model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 58 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 58 --mode complete
```
