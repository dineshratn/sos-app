...
Execute task 93 for the sos-app specification.

## Task Description
Create TimescaleDB schema for location_points hypertable

## Requirements Reference
**Requirements**: 3.0.1, Performance NFR
...
Execute with @spec-task-executor agent the following task: "Create TimescaleDB schema for location_points hypertable"

```
Use the @spec-task-executor agent to implement task 93: "Create TimescaleDB schema for location_points hypertable" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 93
- Description: Create TimescaleDB schema for location_points hypertable
- Requirements: 3.0.1, Performance NFR

## Instructions
- Implement ONLY task 93: "Create TimescaleDB schema for location_points hypertable"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 93 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 93 --mode complete
```
