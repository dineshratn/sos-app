...
Execute task 45 for the sos-app specification.

## Task Description
Create database migration for emergency_contacts table
...
Execute with @spec-task-executor agent the following task: "Create database migration for emergency_contacts table"

```
Use the @spec-task-executor agent to implement task 45: "Create database migration for emergency_contacts table" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 45
- Description: Create database migration for emergency_contacts table
- Requirements: 4.0.1

## Instructions
- Implement ONLY task 45: "Create database migration for emergency_contacts table"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 45 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 45 --mode complete
```
