...
Execute task 63 for the sos-app specification.

## Task Description
Create database migration for medical_conditions table
...
Execute with @spec-task-executor agent the following task: "Create database migration for medical_conditions table"

```
Use the @spec-task-executor agent to implement task 63: "Create database migration for medical_conditions table" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 63
- Description: Create database migration for medical_conditions table
- Requirements: 5.0.1

## Instructions
- Implement ONLY task 63: "Create database migration for medical_conditions table"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 63 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 63 --mode complete
```
