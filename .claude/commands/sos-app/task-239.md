...
Execute task 239 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create countdown dialog"

```
Use the @spec-task-executor agent to implement task 239: "Create countdown dialog" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 239
- Description: Create countdown dialog
- Requirements: 2.0.5

## Instructions
- Implement ONLY task 239: "Create countdown dialog"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 239 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 239 --mode complete
```
