...
Execute task 24 for the sos-app specification.

## Task Description
Create Session model and database schema
...
Execute with @spec-task-executor agent the following task: "Create Session model and database schema"

```
Use the @spec-task-executor agent to implement task 24: "Create Session model and database schema" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Create Session model and database schema
- Requirements: 1.0.3

## Instructions
- Implement ONLY task 24: "Create Session model and database schema"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 24 --mode complete
```
