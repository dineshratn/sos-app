...
Execute task 99 for the sos-app specification.

## Task Description
Create GET location history endpoint (for reporting)
...
Execute with @spec-task-executor agent the following task: "Create GET location history endpoint (for reporting)"

```
Use the @spec-task-executor agent to implement task 99: "Create GET location history endpoint (for reporting)" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 99
- Description: Create GET location history endpoint (for reporting)
- Requirements: 9.0.3

## Instructions
- Implement ONLY task 99: "Create GET location history endpoint (for reporting)"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 99 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 99 --mode complete
```
