...
Execute task 153 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Write unit tests for Device Service"

```
Use the @spec-task-executor agent to implement task 153: "Write unit tests for Device Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 153
- Description: Write unit tests for Device Service
- Requirements: Maintainability NFR

## Instructions
- Implement ONLY task 153: "Write unit tests for Device Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 153 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 153 --mode complete
```
