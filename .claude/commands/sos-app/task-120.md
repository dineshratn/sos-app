...
Execute task 120 for the sos-app specification.

## Task Description
Create notification templates

## Requirements Reference
**Requirements**: 11.0.3, 11.0.6
...
Execute with @spec-task-executor agent the following task: "Create notification templates"

```
Use the @spec-task-executor agent to implement task 120: "Create notification templates" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 120: "Create notification templates"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 120 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 120 --mode complete
```
