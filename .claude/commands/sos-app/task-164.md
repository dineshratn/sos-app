...
Execute task 164 for the sos-app specification.

## Task Description
Create route proxies for Communication Service
...
Execute with @spec-task-executor agent the following task: "Create route proxies for Communication Service"

```
Use the @spec-task-executor agent to implement task 164: "Create route proxies for Communication Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 164
- Description: Create route proxies for Communication Service
- Requirements: 8.0

## Instructions
- Implement ONLY task 164: "Create route proxies for Communication Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 164 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 164 --mode complete
```
