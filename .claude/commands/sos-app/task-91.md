...
Execute task 91 for the sos-app specification.

## Task Description
Create Location Service project structure in Go
...
Execute with @spec-task-executor agent the following task: "Create Location Service project structure in Go"

```
Use the @spec-task-executor agent to implement task 91: "Create Location Service project structure in Go" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 91
- Description: Create Location Service project structure in Go
- Requirements: 3.0 (Real-Time Location Sharing)

## Instructions
- Implement ONLY task 91: "Create Location Service project structure in Go"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 91 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 91 --mode complete
```
