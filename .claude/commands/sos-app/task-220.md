...
Execute task 220 for the sos-app specification.

## Task Description
Create add/edit contact view
...
Execute with @spec-task-executor agent the following task: "Create add/edit contact view"

```
Use the @spec-task-executor agent to implement task 220: "Create add/edit contact view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 220
- Description: Create add/edit contact view
- Requirements: 4.0.1, 4.0.6

## Instructions
- Implement ONLY task 220: "Create add/edit contact view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 220 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 220 --mode complete
```
