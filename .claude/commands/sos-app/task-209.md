...
Execute task 209 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement authentication manager"

```
Use the @spec-task-executor agent to implement task 209: "Implement authentication manager" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 209: "Implement authentication manager"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 209 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 209 --mode complete
```
