...
Execute task 35 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create password reset request endpoint"

```
Use the @spec-task-executor agent to implement task 35: "Create password reset request endpoint" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 35: "Create password reset request endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 35 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 35 --mode complete
```
