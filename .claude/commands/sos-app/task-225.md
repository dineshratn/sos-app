...
Execute task 225 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create chat interface view"

```
Use the @spec-task-executor agent to implement task 225: "Create chat interface view" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 225
- Description: Create chat interface view
- Requirements: 8.0.1, 8.0.5

## Instructions
- Implement ONLY task 225: "Create chat interface view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 225 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 225 --mode complete
```
