...
Execute task 50 for the sos-app specification.

## Task Description
Create POST emergency contact endpoint
...
Execute with @spec-task-executor agent the following task: "Create POST emergency contact endpoint"

```
Use the @spec-task-executor agent to implement task 50: "Create POST emergency contact endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 50
- Description: Create POST emergency contact endpoint
- Requirements: 4.0.1

## Instructions
- Implement ONLY task 50: "Create POST emergency contact endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 50 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 50 --mode complete
```
