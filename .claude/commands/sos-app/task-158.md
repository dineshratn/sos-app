...
Execute task 158 for the sos-app specification.

## Task Description
Create route proxies for Auth Service

## Code Reuse
**Leverage existing code**: http-proxy-middleware npm package
...
Execute with @spec-task-executor agent the following task: "Create route proxies for Auth Service"

```
Use the @spec-task-executor agent to implement task 158: "Create route proxies for Auth Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 158
- Description: Create route proxies for Auth Service
- Leverage: http-proxy-middleware npm package
- Requirements: 1.0

## Instructions
- Implement ONLY task 158: "Create route proxies for Auth Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 158 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 158 --mode complete
```
