...
Execute task 217 for the sos-app specification.

## Task Description
Integrate MapKit for location display
...
Execute with @spec-task-executor agent the following task: "Integrate MapKit for location display"

```
Use the @spec-task-executor agent to implement task 217: "Integrate MapKit for location display" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 217
- Description: Integrate MapKit for location display
- Requirements: 3.0.2, 3.0.3

## Instructions
- Implement ONLY task 217: "Integrate MapKit for location display"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 217 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 217 --mode complete
```
