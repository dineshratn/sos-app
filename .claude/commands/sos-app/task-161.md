...
Execute task 161 for the sos-app specification.

## Task Description
Create route proxies for Location Service
...
Execute with @spec-task-executor agent the following task: "Create route proxies for Location Service"

```
Use the @spec-task-executor agent to implement task 161: "Create route proxies for Location Service" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 161
- Description: Create route proxies for Location Service
- Requirements: 3.0

## Instructions
- Implement ONLY task 161: "Create route proxies for Location Service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 161 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 161 --mode complete
```
