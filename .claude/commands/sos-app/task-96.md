...
Execute task 96 for the sos-app specification.

## Task Description
Create POST location update endpoint
...
Execute with @spec-task-executor agent the following task: "Create POST location update endpoint"

```
Use the @spec-task-executor agent to implement task 96: "Create POST location update endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 96
- Description: Create POST location update endpoint
- Requirements: 3.0.1

## Instructions
- Implement ONLY task 96: "Create POST location update endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 96 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 96 --mode complete
```
