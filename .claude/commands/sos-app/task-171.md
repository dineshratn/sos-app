...
Execute task 171 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create data models with Pydantic"

```
Use the @spec-task-executor agent to implement task 171: "Create data models with Pydantic" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 171
- Description: Create data models with Pydantic
- Requirements: 10.0.2

## Instructions
- Implement ONLY task 171: "Create data models with Pydantic"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 171 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 171 --mode complete
```
