...
Execute task 85 for the sos-app specification.

## Task Description
Create get emergency endpoint
...
Execute with @spec-task-executor agent the following task: "Create get emergency endpoint"

```
Use the @spec-task-executor agent to implement task 85: "Create get emergency endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 85
- Description: Create get emergency endpoint
- Requirements: 2.0, 4.0

## Instructions
- Implement ONLY task 85: "Create get emergency endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 85 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 85 --mode complete
```
