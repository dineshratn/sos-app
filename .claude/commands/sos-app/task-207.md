...
Execute task 207 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create iOS project in Xcode"

```
Use the @spec-task-executor agent to implement task 207: "Create iOS project in Xcode" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 207
- Description: Create iOS project in Xcode
- Requirements: 6.0.1

## Instructions
- Implement ONLY task 207: "Create iOS project in Xcode"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 207 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 207 --mode complete
```
