...
Execute task 227 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Implement background location tracking"

```
Use the @spec-task-executor agent to implement task 227: "Implement background location tracking" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 227
- Description: Implement background location tracking
- Requirements: 6.0.5

## Instructions
- Implement ONLY task 227: "Implement background location tracking"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 227 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 227 --mode complete
```
