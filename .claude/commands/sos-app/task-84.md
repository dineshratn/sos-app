...
Execute task 84 for the sos-app specification.

## Task Description
Create resolve emergency endpoint

## Requirements Reference
**Requirements**: 9.0.1, 9.0.4
...
Execute with @spec-task-executor agent the following task: "Create resolve emergency endpoint"

```
Use the @spec-task-executor agent to implement task 84: "Create resolve emergency endpoint" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 84
- Description: Create resolve emergency endpoint
- Requirements: 9.0.1, 9.0.4

## Instructions
- Implement ONLY task 84: "Create resolve emergency endpoint"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 84 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 84 --mode complete
```
