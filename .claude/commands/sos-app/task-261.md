...
Execute task 261 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Configure Jaeger distributed tracing"

```
Use the @spec-task-executor agent to implement task 261: "Configure Jaeger distributed tracing" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 261
- Description: Configure Jaeger distributed tracing
- Requirements: Reliability NFR - Monitoring

## Instructions
- Implement ONLY task 261: "Configure Jaeger distributed tracing"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 261 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 261 --mode complete
```
