...
Execute task 79 for the sos-app specification.

## Task Description
Implement Kafka producer for emergency events

## Code Reuse
**Leverage existing code**: confluent-kafka-go library

## Requirements Reference
**Requirements**: 2.0, Event-driven architecture
...
Execute with @spec-task-executor agent the following task: "Implement Kafka producer for emergency events"

```
Use the @spec-task-executor agent to implement task 79: "Implement Kafka producer for emergency events" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 79
- Description: Implement Kafka producer for emergency events
- Leverage: confluent-kafka-go library
- Requirements: 2.0, Event-driven architecture

## Instructions
- Implement ONLY task 79: "Implement Kafka producer for emergency events"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 79 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 79 --mode complete
```
