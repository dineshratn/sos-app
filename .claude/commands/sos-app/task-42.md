...
Execute task 42 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create UserProfile model"

```
Use the @spec-task-executor agent to implement task 42: "Create UserProfile model" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 42
- Description: Create UserProfile model
- Requirements: 1.0.2

## Instructions
- Implement ONLY task 42: "Create UserProfile model"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 42 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 42 --mode complete
```
