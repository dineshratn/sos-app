...
Execute task 104 for the sos-app specification.

## Task Description
Implement fallback location provider logic
...
Execute with @spec-task-executor agent the following task: "Implement fallback location provider logic"

```
Use the @spec-task-executor agent to implement task 104: "Implement fallback location provider logic" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 104
- Description: Implement fallback location provider logic
- Requirements: 3.0.5

## Instructions
- Implement ONLY task 104: "Implement fallback location provider logic"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 104 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 104 --mode complete
```
