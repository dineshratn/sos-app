...
Execute task 247 for the sos-app specification.

## Task Description
Create emergency history screen
...
Execute with @spec-task-executor agent the following task: "Create emergency history screen"

```
Use the @spec-task-executor agent to implement task 247: "Create emergency history screen" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 247
- Description: Create emergency history screen
- Requirements: 9.0.2

## Instructions
- Implement ONLY task 247: "Create emergency history screen"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 247 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 247 --mode complete
```
