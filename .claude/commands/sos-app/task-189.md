...
Execute task 189 for the sos-app specification.

## Task Description
Create active emergency view

## Requirements Reference
**Requirements**: 2.0.7, 3.0.2
...
```
Use the @spec-task-executor agent to implement task 189: "Create active emergency view" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 189: "Create active emergency view"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 189 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 189 --mode complete
```
