...
Execute task 20 for the sos-app specification.

## Task Description
Create MQTT Broker Deployment for IoT devices
...
Execute with @spec-task-executor agent the following task: "Create MQTT Broker Deployment for IoT devices"

```
Use the @spec-task-executor agent to implement task 20: "Create MQTT Broker Deployment for IoT devices" for the sos-app specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create MQTT Broker Deployment for IoT devices
- Requirements: 7.0 (External Device Integration)

## Instructions
- Implement ONLY task 20: "Create MQTT Broker Deployment for IoT devices"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 20 --mode complete
```
