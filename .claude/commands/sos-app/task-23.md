...
Execute task 23 for the sos-app specification.
...
Execute with @spec-task-executor agent the following task: "Create database migration for users table"

```
Use the @spec-task-executor agent to implement task 23: "Create database migration for users table" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 23: "Create database migration for users table"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 23 --mode complete
```
