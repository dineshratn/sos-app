...
Execute task 228 for the sos-app specification.
...
```
Use the @spec-task-executor agent to implement task 228: "Implement Bluetooth device pairing" for the sos-app specification and include all the below context.
...
## Instructions
- Implement ONLY task 228: "Implement Bluetooth device pairing"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks sos-app 228 --mode complete
...
```bash
claude-code-spec-workflow get-tasks sos-app 228 --mode complete
```
