...
exports.VoiceToTextService = void 0;
...
class VoiceToTextService {
    ...
    async transcribeAudio(audioBuffer, options = {}) {
        try {
            ...
            logger_1.default.info(`Transcribing audio (${audioBuffer.length} bytes) with language: ${languageCode}`);
     ...
     */
    mockTranscription(audioBuffer, languageCode) {
        // Simulate processing delay
        const processingDelay = Math.min(audioBuffer.length / 10000, 2000);
        logger_1.default.info(`Mock transcription processing (${processingDelay}ms delay)`);
     ...
     */
    generateMockWords(transcription) {
     ...
     */
    async transcribeWithGoogleCloud(audioBuffer, options) {
        logger_1.default.warn('Google Cloud Speech-to-Text integration not implemented yet');
     ...
     */
    estimateTranscriptionCost(audioBuffer) {
...
exports.VoiceToTextService = VoiceToTextService;
exports.default = new VoiceToTextService();
//# sourceMappingURL=voiceToText.service.js.map