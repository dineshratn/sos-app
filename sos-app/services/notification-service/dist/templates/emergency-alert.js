...
exports.websocketTemplates = exports.emailTemplates = exports.smsTemplates = exports.pushTemplates = void 0;
...
exports.pushTemplates = {
    emergencyAlert: {
        title: (data) => `🆘 EMERGENCY: ${data.userName} needs help!`,
        body: (data) => `${data.emergencyType} emergency at ${data.address || data.location}. Tap to respond immediately.`,
    },
    acknowledgment: {
        title: (data) => `${data.acknowledgedBy} has acknowledged your emergency`,
        body: (data) => `${data.acknowledgedBy} received your alert and is responding.`,
    },
    escalation: {
        title: (data) => `🚨 URGENT: ${data.userName} still needs help!`,
        body: (data) => `${data.emergencyType} emergency - primary contacts haven't responded. Immediate assistance needed.`,
    },
    followUp: {
        title: (data) => `⚠️ REMINDER: ${data.userName} needs help`,
        body: (_data) => `Emergency still active. Please acknowledge and respond if you can assist.`,
    },
};
/**
 * SMS templates
...
exports.smsTemplates = {
    emergencyAlert: (data) => `🆘 EMERGENCY ALERT!\n\n` +
    ...
    acknowledgment: (data) => `✓ ${data.acknowledgedBy} has acknowledged your emergency alert and is responding.\n\n` +
        `Emergency ID: ${data.emergencyLink}`,
    escalation: (data) => `🚨 URGENT ESCALATION\n\n` +
...
exports.emailTemplates = {
    emergencyAlert: {
        subject: (data) => `🆘 EMERGENCY: ${data.userName} needs immediate help`,
        text: (data) => `EMERGENCY ALERT\n\n` +
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f4f4; padding: 20px;">
    ...
    escalation: {
        subject: (data) => `🚨 URGENT ESCALATION: ${data.userName} needs immediate help`,
        text: (data) => `URGENT ESCALATION\n\n` +
            ...
            `Time sent: ${new Date().toLocaleString()}`,
        html: (_data) => `<!-- Similar HTML structure with urgent styling -->`,
    },
    followUp: {
        subject: (data) => `⚠️ REMINDER: ${data.userName} still needs help`,
        text: (data) => `EMERGENCY REMINDER\n\n` +
 ...
 */
function getTemplate(type, channel, data) {
    switch (channel) {
        case 'PUSH':
            return exports.pushTemplates[type] ? exports.pushTemplates[type] : exports.pushTemplates.emergencyAlert;
        case 'SMS':
            return exports.smsTemplates[type] ? exports.smsTemplates[type](data) : exports.smsTemplates.emergencyAlert(data);
        case 'EMAIL':
            return exports.emailTemplates[type] || exports.emailTemplates.emergencyAlert;
        case 'WEBSOCKET':
            return exports.websocketTemplates[type] ? exports.websocketTemplates[type](data) : exports.websocketTemplates.emergencyAlert(data);
        default:
            return null;
    }
}
//# sourceMappingURL=emergency-alert.js.map